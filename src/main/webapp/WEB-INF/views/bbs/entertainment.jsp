...
<body>
    ...
    <br><br><br><br><br>
    <div class="mt-3 ms-3 fs-2 d-flex justify-content-center "><span><a href="/bbs/entertainment" id="maintitle">entertainment</a></span></div>
...
<script>
    (()=>{
        let subName = 'entertainment';    // 게시판의 이름
        let bstr;
