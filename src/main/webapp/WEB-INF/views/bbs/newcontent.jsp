    ...
    <div class="total">
      ...
      <div class="main2">
          <div class="form-group">
              ...
              <input type="text" class="form-control bg-secondary p-2 text-dark bg-opacity-10" id="txtTitle" name="title" placeholder="제목을 작성해주세요.">
          </div> <br>
          ...
          <div id="content">
              <div class="form-group">
                  ...
                  <textarea class="form-control bg-secondary p-2 bg-opacity-10" id="txtContent" name="contents" rows="25" placeholder="내용을 작성해주세요."></textarea>
              </div>
          </div>   
    <br>
    <div class="btn2">
      <button type="button" id="btnList" class="btn btn2 btn-secondary">목록으로</button>    
      <button type="button" id="btnInsert" class="btn btn2 btn-secondary">등록</button>
    </div>
    </div>
    <br><br><br>
    <footer>
...
<script>
    (()=>{
        ...
        const thumbnail = document.querySelector('#formFileMultiple');
