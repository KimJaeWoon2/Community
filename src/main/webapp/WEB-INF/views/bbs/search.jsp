...
<body>
    ...
    <br><br><br><br><br>
    <div class="mt-3 ms-3 fs-2 d-flex justify-content-center "><span><a href="/bbs/${vo.sub}" id="maintitle">${vo.sub}</a></span></div>
...
<script>
    (()=>{
        ...
        const btnRecom = document.querySelector('#btnRecommend');
        const btnAll = document.querySelector('#btnAll'); // 전체 게시물
        ...
        const setBBS = function(page)
            {
                let requestData = {
                    ...
                    exception_mode : '${vo.exception_mode}'
                };
