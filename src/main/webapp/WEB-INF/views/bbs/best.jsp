...
<body>
    ...
    <br><br><br><br><br>
    <div class="mt-3 ms-3 fs-2 d-flex justify-content-center "><span><a href="/bbs/best" id="maintitle">인기</a></span></div>
    ...
    <div  class="mt-1 d-flex justify-content-center">
        ...
        <div class="d-flex justify-content-center mt-3">
            ...
            <button type="button" class="btn pageBtn" id="btnBlank">...</button>
...
<script>
    (()=>{
        ...
        const setBBS = function(page)
            {   
                let exception_mode = 'HotRecommend';
                let requestData = {                    
                    page : page,
                ...
                $.ajax({
                        ...
                        {                               
                            ...
                            {
                                bstr = '';
                                const rplyRowCount = data.bbsList[i].rplyRowCount;
                                let additionalText = '';
                                like = data.bbsList[i].likeCount;
                                let colorClass;
                                if(like < 0)
                                {
                                ...
                                bstr += '<tr>';
                                    bstr += '<td class="text-center span">' +'<a id="titleStyle" href=\"/bbs/'+ data.bbsList[i].sub +'\">' + data.bbsList[i].sub + '</a></td>';
    ...
    btnSearch.addEventListener('click', ()=>{
        ...
        {
            location.href = '/bbs/search?searchType='+reqData.searchType+'&keyWord='+reqData.keyWord
        }       
    });
