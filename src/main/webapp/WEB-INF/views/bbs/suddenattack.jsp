...
<body>
    ...
    <br><br><br><br><br>
    <div class="mt-3 ms-3 fs-2 d-flex justify-content-center "><span><a href="/bbs/suddenattack" id="maintitle">suddenattack</a></span></div>
...
<script>
    (()=>{
        let subName = 'suddenattack';    // 게시판의 이름
        let bstr;
