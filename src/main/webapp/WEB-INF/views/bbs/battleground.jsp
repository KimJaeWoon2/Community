...
<body>
    ...
    <br><br><br><br><br>
    <div class="mt-3 ms-3 fs-2 d-flex justify-content-center "><span><a href="/bbs/battleground" id="maintitle">battleground</a></span></div>
...
<script>
    (()=>{
        let subName = 'battleground';    // 게시판의 이름
        let bstr;
